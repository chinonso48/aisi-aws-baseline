...
variable "create_kms_for_ebs" { type = bool, default = true }
variable "create_kms_for_logs" { type = bool, default = true }
variable "create_kms_for_data" { type = bool, default = true }

variable "kms_ebs_key_arn"  { type = string, default = "" }
variable "kms_logs_key_arn" { type = string, default = "" }
variable "kms_data_key_arn" { type = string, default = "" }
